package com.dmp.pansoft.flume.sink;

import com.dmp.pansoft.flume.parquet.serializer.WindowsLogSerializer;
import com.dmp.pansoft.flume.parquet.sink.HDFSParquetSink;
...
public class HDFSParquetSinkWindowsTest1 {
    private HDFSParquetSink sut;
    private MemoryChannel memoryChannel;

    @Before
    public void startUp() throws IOException {
        String filePath = "/parquet/data/";
//        String filePath = "hdfs://hadoop2:8020/flume/events";
